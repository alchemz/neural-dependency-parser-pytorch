...
class PartialParse(object):
    def __init__(self, sentence):
        ...
        # initialize class vars of stack, buffer, and dependencies
        self.stack = ['ROOT']
